export function divis(image1, image2, imgData1, imgData2) {
    ...
    if (((image2.height > image1.height) || (image1.height > image2.height)) && (image1.width == image2.width)) {
        for (let i = 0; i < newImgData.data.length; i += 4) {
            ...
            newImgData.data[i] = newImgData.data[i] * 100
            newImgData.data[i + 1] = newImgData.data[i + 1] * 100
            newImgData.data[i + 2] = newImgData.data[i + 2] * 100
            newImgData.data[i + 3] = 255
        }
    }
        ...
        for (let i = 0; i < newImgData.data.length; i += 4) {
            ...
            if (i >= start2) {
                if (newImgData.data[i] == 0) {
                    ...
                    newImgData.data[i] /= imgData2.data[inserteds2] * 100
                    newImgData.data[i + 1] /= imgData2.data[inserteds2 + 1] * 100
                    newImgData.data[i + 2] /= imgData2.data[inserteds2 + 2] * 100
                    newImgData.data[i + 3] /= imgData2.data[inserteds2 + 3] * 100
                }
                inserteds2 += 4
        ...
        for (let i = 0; i < newImgData.data.length; i += 4) {
            ...
            if (i >= start2) {
                if (inserteds2 < imgData2.data.length) {
                    if ((image1.height > image2.height) && (image1.width > image2.width)) {
                        newImgData.data[i] = newImgData.data[i] / imgData2.data[inserteds2] * 100
                        newImgData.data[i + 1] = newImgData.data[i + 1] / imgData2.data[inserteds2 + 1] * 100
                        newImgData.data[i + 2] = newImgData.data[i + 2] / imgData2.data[inserteds2 + 2] * 100
                        newImgData.data[i + 3] = newImgData.data[i + 3] / imgData2.data[inserteds2 + 3] * 100
                    } else if (newImgData.data[i] == 0) {
                        newImgData.data[i] = imgData2.data[inserteds2]
                        newImgData.data[i + 1] = imgData2.data[inserteds2 + 1]
                        newImgData.data[i + 2] = imgData2.data[inserteds2 + 2]
                        newImgData.data[i + 3] = imgData2.data[inserteds2 + 3]
                    } else {
                        newImgData.data[i] = imgData2.data[inserteds2] / newImgData.data[i] * 100
                        newImgData.data[i + 1] = imgData2.data[inserteds2 + 1] / newImgData.data[i + 1] * 100
                        newImgData.data[i + 2] = imgData2.data[inserteds2 + 2] / newImgData.data[i + 2] * 100
                        newImgData.data[i + 3] = imgData2.data[inserteds2 + 3] / newImgData.data[i + 3] * 100
                    }
                    inserteds2 += 4
    ...
    if ((image1.height == image2.height) && (image1.width == image2.width)) {
        for (let i = 0; i < newImgData.data.length; i += 4) {
            newImgData.data[i] = imgData1.data[i] / imgData2.data[i] * 100
            newImgData.data[i + 1] = imgData1.data[i + 1] / imgData2.data[i + 1] * 100
            newImgData.data[i + 2] = imgData1.data[i + 2] / imgData2.data[i + 2] * 100
            newImgData.data[i + 3] = 255
        }
    }
    return newImgData
...
export function divisWidth(image1, image2) {
    if (image1.width > image2.width) { return image1.width } else { return image2.width }
}

export function divisHeight(image1, image2) {
