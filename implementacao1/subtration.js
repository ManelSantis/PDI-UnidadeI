export function sub(image1, image2, imgData1, imgData2) {
    ...
    if (((image2.height > image1.height) || (image1.height > image2.height)) && (image1.width == image2.width)) {
        for (let i = 0; i < newImgData.data.length; i += 4) {
            ...
            if ((i >= start2) && (i <= end2)) {
                ...
                } else if ((image2.width > image1.width) && (newImgData.data[i] != 0)) {
                    newImgData.data[i] = imgData2.data[i] - newImgData.data[i]
                    newImgData.data[i + 1] = imgData2.data[i + 1] - newImgData.data[i + 1]
                    newImgData.data[i + 2] = imgData2.data[i + 2] - newImgData.data[i + 2]
                    newImgData.data[i + 3] = imgData2.data[i + 3] - newImgData.data[i + 3]
                } else {
                    newImgData.data[i] -= imgData2.data[i]
                    newImgData.data[i + 1] -= imgData2.data[i + 1]
                    newImgData.data[i + 2] -= imgData2.data[i + 2]
            ...
            if (newImgData.data[i] < 0) { newImgData.data[i] *= -1 }
            if (newImgData.data[i + 1] < 0) { newImgData.data[i + 1] *= -1 }
            if (newImgData.data[i + 2] < 0) { newImgData.data[i + 2] *= -1 }
            if (newImgData.data[i + 3] < 0) { newImgData.data[i + 3] *= -1 }
        }
    }
        ...
        for (let i = 0; i < newImgData.data.length; i += 4) {
            ...
            if (i >= start2) {
                if (newImgData.data[i] == 0) {
                    ...
                    newImgData.data[i] = imgData2.data[inserteds2] - newImgData.data[i]
                    newImgData.data[i + 1] = imgData2.data[inserteds2 + 1] - newImgData.data[i + 1]
                    newImgData.data[i + 2] = imgData2.data[inserteds2 + 2] - newImgData.data[i + 2]
                    newImgData.data[i + 3] = imgData2.data[inserteds2 + 3] - newImgData.data[i + 3]
                } else {
                    newImgData.data[i] -= imgData2.data[inserteds2]
                    newImgData.data[i + 1] -= imgData2.data[inserteds2 + 1]
                    newImgData.data[i + 2] -= imgData2.data[inserteds2 + 2]
...
export function subWidth(image1, image2) {
    if (image1.width > image2.width) { return image1.width } else { return image2.width }
}

export function subHeight(image1, image2) {
