export function and(image1, image2, imgData1, imgData2) {
    ...
    if ((image1.height == image2.height) && (image1.width == image2.width)) {
        for (let i = 0; i < newImgData.data.length; i += 4) {
            ...
            newImgData.data[i + 3] = imgData1.data[i + 3] & imgData2.data[i + 3]
        }
    }
...
export function andWidth(image1, image2) {
    if (image1.width > image2.width) { return image1.width } else { return image2.width }
}

export function andHeight(image1, image2) {
