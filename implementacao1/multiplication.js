export function multi(image1, image2, imgData1, imgData2) {
    ...
    if (((image2.height > image1.height) || (image1.height > image2.height)) && (image1.width == image2.width)) {
        for (let i = 0; i < newImgData.data.length; i += 4) {
            newImgData.data[i] = 1
            newImgData.data[i + 1] = 1
            newImgData.data[i + 2] = 1
            ...
            if ((i >= start2) && (i <= end2)) {
                newImgData.data[i] *= imgData2.data[i] / 100
                newImgData.data[i + 1] *= imgData2.data[i + 1] / 100
                newImgData.data[i + 2] *= imgData2.data[i + 2] / 100
            }
...
export function multiWidth(image1, image2) {
    if (image1.width > image2.width) { return image1.width } else { return image2.width }
}

export function multiHeight(image1, image2) {
